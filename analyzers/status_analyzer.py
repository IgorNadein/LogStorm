...
class StatusAnalyzer:
    ...
    def analyze_early_leave(record: AttendanceRecord) -> Tuple[bool, int]:
        ...
        Логика:
        - Ранний уход если человек ушел раньше schedule_end
        - Неважно, сколько часов он отработал и во сколько пришел
        - Важно только время ухода относительно графика
        
        Пример:
        - График 8:00-17:00, пришел 7:00, ушел 16:00 → ранний уход
        - График 8:00-17:00, пришел 8:00, ушел 16:00 → ранний уход
        - График 8:00-17:00, пришел 9:00, ушел 17:00 → НЕ ранний уход
