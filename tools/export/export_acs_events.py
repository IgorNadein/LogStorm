...
Примеры:
  # Простой экспорт
  python export_events.py --password secret --end 2025-12-31T23:59:59

  # Экспорт большого периода с разбиением по 30 дней
  python export_events.py --password secret \\
...
Примеры:
  ...
  python export_events.py --password secret --end 2025-12-31T23:59:59 --append

  # Продолжение прерванного экспорта
  python export_events.py --password secret --end 2025-12-31T23:59:59 --resume
        """
    )
