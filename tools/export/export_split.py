...
Примеры использования:
  ...
  python export_split.py --password secret --start 2024-01-01 --end 2024-12-31

  # С сохранением промежуточных файлов
  python export_split.py --password secret --start 2024-01-01 --end 2024-12-31 --keep-chunks

  # Продолжение прерванного экспорта (пропускает существующие файлы)
  python export_split.py --password secret --start 2024-01-01 --end 2024-12-31 --keep-chunks

  # Принудительный перезапуск
  python export_split.py --password secret --start 2024-01-01 --end 2024-12-31 --force
        """
    )
