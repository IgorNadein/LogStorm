...
python export_acs_events.py --password secret --end 2025-12-31T23:59:59 --force
```

### Дедупликация
```bash
# Включить фильтрацию дубликатов
python export_acs_events.py --password secret --end 2025-12-31T23:59:59 --deduplicate

# Дополнение файла (авто-дедупликация)
python export_acs_events.py --password secret --end 2025-12-31T23:59:59 --append
```

### Продолжение прерванного экспорта
```bash
python export_acs_events.py --password secret --end 2025-12-31T23:59:59 --resume
```
...
```json
{"major": 5, "minor": 75, "time": "2025-12-01T06:05:04+03:00", "serialNo": 97659, "name": "Иванов"}
{"major": 5, "minor": 104, "time": "2025-12-01T17:30:15+03:00", "serialNo": 97662, "name": "Иванов"}
```
